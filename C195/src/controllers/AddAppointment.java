...
public class AddAppointment {
    ...
    @FXML
    private ChoiceBox<Time> startAmPmChoiceBox;
    @FXML
    private ChoiceBox<Time> startMinuteChoiceBox;
    @FXML
    private ChoiceBox<Time> startHourChoiceBox;

    @FXML
    private ChoiceBox<Time> endAmPmChoiceBox;
    @FXML
    private ChoiceBox<Time> endMinuteChoiceBox;
    @FXML
    ...
    @FXML
    private Label addAppointmentMessageLabel;
